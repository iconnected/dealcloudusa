                        ...
                        */
                        ...
                        if($specialItem <= 8){
                            ...
                            */
                            ...
                            echo "<div class=\"featured-item featured-item-special\" style=\"height:230px;\">";
                            ...
                            if ($listing["title"]) {
                                ...
                                echo "<h3><a href=\"".$promotionLink."\" title=\"".string_htmlentities($listing["title"])."\">".$listingName."</a></h3>";
                            } else {
							 ...
							 echo "<p><a href=\"".$promotionLink."\" title=\"".$promotion["name"]."\">".$promotion["name"]."</a></p>";
                            echo "</div>";
